...
void configuration_arr(myCell ** matrix, int msizex, int msizey){
  ...
  for (int i = 0; i < confs; i++){
    ...
    if (configType[i]==1){
      ...
      R_pentomino_insert_arr(loc_config_x[i],loc_config_y[i],matrix); //matrix is a type myCell matrix of pointer
    }
      ...
      Diehard_insert_arr(loc_config_x[i],loc_config_y[i],matrix); //matrix is a type myCell matrix of pointer
    }
      ...
      Acorn_insert_arr(loc_config_x[i],loc_config_y[i],matrix); //matrix is a type myCell matrix of pointer
    }
  }
  return;
}
